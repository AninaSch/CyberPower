...
surveillance <- CPI %>%
  select(country,laws, attack_surveillance, freedom_net, freedom_press, cyber_firm, socials_use, internet_use, cybermil_people)
...
# CPI_overall
data_norm = normalise_ci(overall,c(2:27),c("POS","POS","POS","NEG","POS","POS","NEG","POS","POS","POS",
...
# CPI_surveillance
data_norm1 = normalise_ci(surveillance,c(2:9),c("POS","POS","POS","POS","POS","POS","POS","POS"),
                         method=1,z.mean=50, z.std=20) #   method=1,z.mean=50, z.std=10)
...
# CPI_defense
data_norm2 = normalise_ci(defense,c(2:11),c("POS","NEG","POS","POS","POS","NEG","NEG","POS","POS","POS"),
                          method=1,z.mean=50, z.std=20) #   method=1,z.mean=50, z.std=10)
...
# CPI_manipulation
data_norm3 = normalise_ci(manipulation,c(2:9),c("POS","POS","POS","POS","POS","POS","POS","NEG"),
                          method=1,z.mean=50, z.std=20) #   method=1,z.mean=50, z.std=10)
...
# CPI_commercial
data_norm5 = normalise_ci(commercial,c(2:7),c("POS","POS","POS","POS","POS","POS"),
                          method=1,z.mean=50, z.std=20) #   method=1,z.mean=50, z.std=10)
...
# CPI_disruption
data_norm6 = normalise_ci(disruption,c(2:4),c("POS","POS","POS"),
                          method=1,z.mean=50, z.std=20) #   method=1,z.mean=50, z.std=10)
