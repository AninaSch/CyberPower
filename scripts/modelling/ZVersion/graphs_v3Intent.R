...
all <- CPI_scores %>%
  ungroup(country) %>%
  select(country, Surveillance = score_surveillance, Defense = score_defense, `Info Control` = score_control, 
         Intelligence = score_intelligence, Commercial = score_commercial, Offense = score_offense, Norms = score_norms) %>%
